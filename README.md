...
<br/> 본 프로젝트의 사용환경은 1> 폐기물을 배출하고자 하는 분리수거함에 내용물이 있는 상태, 2> 사용자(시각장애인)이 배출하고자 하는 폐기물은 촉각을 통해 미리 분류를 해둔 상태를 가정하고 있다.
...
<br/>(1) Real-time Object Detection(실시간 객체 인식) 모듈
...
<br/>(2) Text-To-Speech(이하 TTS, 음성 인식) 모듈
어떤 오픈소스 사용하였는지??
